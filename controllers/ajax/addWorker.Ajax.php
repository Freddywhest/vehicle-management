    ...
    if(isset($_SESSION['userUuid'], $_SESSION['userEmail'], $_SESSION['userRole']) && isset($_COOKIE['userUuid'])){
        ...
        if(isset($_POST['workerEmail'])){
            ...
            if(CheckUser::$userAvailable === true){
                ...
                $workerExpCompany = !empty($_POST['workerExpCompany']) ? implode('|', array($_POST['workerExpCompany'])) : NULL;
                $workerExpFrom = !empty($_POST['workerExpFrom']) ? implode('|', array($_POST['workerExpFrom'])) : NULL;
                $workerExpTo = !empty($_POST['workerExpTo']) ? implode('|', array($_POST['workerExpTo'])) : NULL;
                $workerExpPosition = !empty($_POST['workerExpPosition']) ? implode('|', array($_POST['workerExpPosition'])) : NULL;
                $reasonLeaving = !empty($_POST['reasonLeaving']) ? implode('|', array($_POST['reasonLeaving'])) : NULL;
                $eduSchoolName = !empty($_POST['eduSchoolName']) ? implode('|', array($_POST['eduSchoolName'])) : NULL;
                $eduSchoolLocation = !empty($_POST['eduSchoolLocation']) ? implode('|', array($_POST['eduSchoolLocation'])) : NULL;
                $eduSchoolGrad = !empty($_POST['eduSchoolGrad']) ? implode('|', array($_POST['eduSchoolGrad'])) : NULL;
